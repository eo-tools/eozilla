...
#   filename:  client.py:
#   timestamp: 2025-12-05T17:26:48.592707
...
class Client(ClientMixin):
    ...
    def get_capabilities(self, **kwargs: Any) -> Capabilities:
        ...
        For more information, see [OGC API — Processes — Part 1 Section
    ...
    def get_conformance(self, **kwargs: Any) -> ConformanceDeclaration:
        ...
        For more information, see [OGC API — Processes — Part 1 Section 7.4](htt
        ps://docs.ogc.org/is/18-062r2/18-062r2.html#sc_conformance_classes).
    ...
    def get_process(self, process_id: str, **kwargs: Any) -> ProcessDescription:
        ...
        For more information, see [OGC API — Processes — Part 1 Section 7.10](ht
        tps://docs.ogc.org/is/18-062r2/18-062r2.html#sc_process_description).
    ...
    def get_job(self, job_id: str, **kwargs: Any) -> JobInfo:
        ...
        For more information, see [OGC API — Processes — Part 1 Section 7.12](ht
        tps://docs.ogc.org/is/18-062r2/18-062r2.html#sc_retrieve_status_info).
    ...
    def get_job_results(self, job_id: str, **kwargs: Any) -> JobResults:
        ...
        For more information, see [OGC API — Processes — Part 1 Section 7.13](ht
        tps://docs.ogc.org/is/18-062r2/18-062r2.html#sc_retrieve_job_results).
